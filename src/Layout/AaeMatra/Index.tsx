...
const Drum1Map = [
  { name: 'ढोल', audioUrl: '/assets/mp3/words/ढोल.mp3' }
];
const PeacockMap = [
...
const Peacock1Map = [
  { name: 'मोर', audioUrl: '/assets/mp3/words/मोर.mp3' }
];
const HorseMap = [
...
const Horse1Map = [
  { name: 'घोड़ा', audioUrl: '/assets/mp3/words/घोड़ा.mp3' }
];
const CuckooMap = [
...
const Cuckoo1Map = [
  { name: 'कोयल', audioUrl: '/assets/mp3/words/कोयल.mp3' }
];
const CoatMap = [
  { name: 'क', audioUrl: '/assets/mp3/vyanjan/क.mp3' },
  { name: 'ो', audioUrl: '/assets/mp3/matraein/ो.mp3' },
...
const Coat1Map = [
  { name: 'कोट', audioUrl: '/assets/mp3/words/कोट.mp3' }
];
const ParrotMap = [
...
const Parrot1Map = [
  { name: 'तोता', audioUrl: '/assets/mp3/words/तोता.mp3' }
];
const CapMap = [
  { name: 'ट', audioUrl: '/assets/mp3/vyanjan/ट.mp3' },
  { name: 'ो', audioUrl: '/assets/mp3/matraein/ो.mp3' },
...
const Cap1Map = [
  { name: 'टोपी', audioUrl: '/assets/mp3/words/टोपी.mp3' }
];
const NoiseMap = [
...
const Noise1Map = [
  { name: 'शोर', audioUrl: '/assets/mp3/words/शोर.mp3' }
];
...
const Round1Map = [
  { name: 'गोल', audioUrl: '/assets/mp3/words/गोल.mp3' }
];
const LanguagesMap = [
...
const Languages1Map = [
  { name: 'बोली', audioUrl: '/assets/mp3/words/बोली.mp3' }
];
const BowlMap = [
  { name: 'क', audioUrl: '/assets/mp3/vyanjan/क.mp3' },
  { name: 'ट', audioUrl: '/assets/mp3/vyanjan/ट.mp3' },
...
const Bowl1Map = [
  { name: 'कटोरी', audioUrl: '/assets/mp3/words/कटोरी.mp3' }
];
const LapMap = [
  { name: 'ग', audioUrl: '/assets/mp3/vyanjan/ग.mp3' },
  { name: 'ो', audioUrl: '/assets/mp3/matraein/ो.mp3' },
...
const Lap1Map = [
  { name: 'गोद', audioUrl: '/assets/mp3/words/गोद.mp3' }
];
const HoliMap = [
...
const Holi1Map = [
  { name: 'होली', audioUrl: '/assets/mp3/words/होली.mp3' }
];
const basketMap = [
  { name: 'ट', audioUrl: '/assets/mp3/vyanjan/ट.mp3' },
  { name: 'ो', audioUrl: '/assets/mp3/matraein/ो.mp3' },
...
const basket1Map = [
  { name: 'टोकरी', audioUrl: '/assets/mp3/words/टोकरी.mp3' }
];
const PassionMap = [
...
const Passion1Map = [
  { name: 'जोश', audioUrl: '/assets/mp3/words/जोश.mp3' }
];
const WashermanMap = [
...
const Washerman1Map = [
  { name: 'धोबी', audioUrl: '/assets/mp3/words/धोबी.mp3' }
];
const DholakMap = [
...
const Dholak1Map = [
  { name: 'ढोलक', audioUrl: '/assets/mp3/words/ढोलक.mp3' }
];
const SensesMap = [
  { name: 'ह', audioUrl: '/assets/mp3/vyanjan/ह.mp3' },
  { name: 'ो', audioUrl: '/assets/mp3/matraein/ो.mp3' },
...
const Senses1Map = [
  { name: 'होश', audioUrl: '/assets/mp3/words/होश.mp3' }
];
const PearlMap = [
  { name: 'म', audioUrl: '/assets/mp3/vyanjan/म.mp3' },
  { name: 'ो', audioUrl: '/assets/mp3/matraein/ो.mp3' },
...
const Pearl1Map = [
  { name: 'मोती', audioUrl: '/assets/mp3/words/मोती.mp3' }
];
const SamosaMap = [
...
const Samosa1Map = [
  { name: 'समोसा', audioUrl: '/assets/mp3/words/समोसा.mp3' }
];
        ...
        <div className={styles.LearningWrap}>
          <Container>
            <div className={styles.baloonTitle}>
              <h2>ओ Matra - Pop all the balloons!  🤪🎈🎊</h2>
            </div>
