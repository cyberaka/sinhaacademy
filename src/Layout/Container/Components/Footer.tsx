    ...
    <div className={styles.Footer}>
      <Container>
        <div className={styles.footerCont}>
          ...
          <p>
            Embark on a fun-filled journey of learning Hindi with Sinha Academy. Explore our resources and let your
            child discover the beauty of the Hindi language, all for free.
          </p>
